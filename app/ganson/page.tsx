      ...
      <div ref={pageRef} id="ganson-page" className="ganson-page">
        ...
        <div className="ganson-page__inner">
          <section className="ganson-page__meta" aria-label="Project metadata" data-reveal data-reveal-delay="80">
            <h1 className="ganson-page__title">Optimizing the BigCommerce Path-to-Purchase for Ganson</h1>
            ...
            <div className="ganson-page__meta-row">
              <div className="ganson-page__meta-group ganson-page__meta-group--content">
                <div className="ganson-page__meta-item">
                  <h6>Background</h6>
                  <p>
                    Ganson Engineering serves a large base of B2B and B2C clients. However, their{" "}
                    <strong>BigCommerce store was outdated and hard to navigate</strong>. Users struggled to find parts in the massive catalog. This created a disconnect between their brand reputation and the online customer experience.
                  </p>
                </div>
                <div className="ganson-page__meta-item">
                  <h6>The Challenge</h6>
                  <p>
                    <strong>Turn high traffic into completed sales</strong>. Analytics showed users were browsing but not buying. The site had too much friction. I needed to fix the Information Architecture (IA) and visual design. The challenge was to stop cart abandonment and simplify the buying process for B2C and B2B customers.
                  </p>
                </div>
                <div className="ganson-page__meta-item">
                  <h6>The Impact</h6>
              ...
              <div className="ganson-page__meta-group ganson-page__meta-group--details">
                ...
                <div className="ganson-page__meta-item">
                  <h6>Website</h6>
                  <p>
                    <a href="https://ganson-store.com/" target="_blank" rel="noopener noreferrer">ganson-store.com</a>
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="ganson-page__image-block" data-reveal data-reveal-delay="80">
            <img src="/Images/Ganson/ganson1.png" alt="Ganson project" width={1440} height={960} />
          </div>

          <section className="ganson-conversions" aria-label="Conversions and workflow" data-reveal data-reveal-delay="80">
            <div className="ganson-conversions__inner">
              <div className="ganson-conversions__header">
                <h2 className="ganson-conversions__title">Maximizing Conversions & Workflow Efficiency</h2>
                <p className="ganson-conversions__subtext">Users weren&apos;t just &quot;browsing&quot;. They were mission-critical buyers looking for specific products to buy in bulk. The design needed to prioritize find-ability over discovery.</p>
              </div>
              <div className="ganson-conversions__points">
                <div className="ganson-conversions__point">
                  <div className="ganson-conversions__point-row">
                    ...
                    <h3 className="ganson-conversions__point-title">Product Clarity</h3>
                  </div>
                  <p className="ganson-conversions__point-desc">Implementing a high-clarity search and filtering architecture</p>
                </div>
                <div className="ganson-conversions__point">
                  <div className="ganson-conversions__point-row">
                    <span className="ganson-conversions__point-num">02</span>
                    <h3 className="ganson-conversions__point-title">Recurring Revenue</h3>
                  </div>
                  <p className="ganson-conversions__point-desc">Enhancing product organization and re-ordering tools</p>
                </div>
              </div>
            </div>
          </section>

          <section className="ganson-feature ganson-feature--1" aria-label="Feature 1: Increasing Findability" data-reveal data-reveal-delay="80">
          ...
          <section id="feature-2-seamless-browsing" className="ganson-feature ganson-feature--2" aria-label="Feature 2: Seamless Browsing" data-reveal data-reveal-delay="80">
            <div className="ganson-feature__header">
              <div className="ganson-feature__header-row">
                <div className="ganson-feature__header-left">
          ...
          <section className="ganson-feature ganson-feature--info-org" aria-label="Feature 3: Information Organization" data-reveal data-reveal-delay="80">
            <div className="ganson-feature__header">
              <div className="ganson-feature__header-row">
                <div className="ganson-feature__header-left">
            ...
            <p className="ganson-feature__caption ganson-feature__caption--block">To reduce the friction of finding technical parts, I implemented a <strong>robust comparison tool and filtering logic</strong> that empowers users to isolate specific attributes (Left). Complementing this, the <strong>search results (Right)</strong> were designed for <strong>rapid validation</strong>, exposing essential data points upfront to accelerate the procurement workflow.</p>
          </section>

          <section className="ganson-feature ganson-feature--4-reorder" aria-label="Feature 4: Project Lists and Re-ordering" data-reveal data-reveal-delay="80">
            <div className="ganson-feature__header">
              <div className="ganson-feature__header-row">
                <div className="ganson-feature__header-left">
                ...
                <div className="ganson-feature__header-right">
                  <p className="ganson-feature__user-story-label">User Story</p>
                  <p className="ganson-feature__user-story-quote">&ldquo;As a Procurement Manager, I need to organize parts into separate lists (&lsquo;Warehouse A&rsquo; vs. &lsquo;Warehouse B&rsquo;) so that I can quickly re-order for specific projects without searching for individual items every month.&rdquo;</p>
                </div>
              </div>
            </div>
            <div className="ganson-feature__grid ganson-product-layout__single">
              <div className="ganson-feature__item">
                <img src="/Images/Ganson/ganson8.png" alt="Feature 4: Project Lists and Re-ordering — wishlist view with project lists and actions" width={1440} height={960} />
              </div>
            </div>
          </section>

          <div className="ganson-page__image-block" aria-label="Additional screens: product detail, about us, compare products">
            <img src="/Images/Ganson/ganson9.png" alt="Additional screens: product detail, about us, compare products on mobile" width={1440} height={960} />
          </div>
